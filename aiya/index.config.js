...
var index_config_default = {
 ...
 t4: {list: [
    ...
    {name: "👖裤佬丨短剧丨聚合",
      address: "http://zhangqun1818.serv00.net:6628/?spider=短剧聚合"},
    {name: "👖裤佬丨电台丨聚合",
    ...
    {name: "👖🔞裤佬丨日本丨大秀",
      address: "https://learnpython.ggff.net/rbdxStymei"},
    {name: "👖🔞裤佬丨51丨吃瓜",
      address: "https://learnpython.ggff.net/wycgStymei"},
    {name: "👖🔞裤佬丨91丨吃瓜",
      address: "https://learnpython.ggff.net/jycgStymei"},
    {name: "👖🔞裤佬丨今日丨吃瓜",
      address: "https://learnpython.ggff.net/jrcgStymei"},
    {name: "👖🔞裤佬丨黑料丨吃瓜",
      address: "https://learnpython.ggff.net/HLBDY"},
    {name: "👖🔞裤佬丨MissAV丨爬虫",
      address: "https://catbox.n13.club/t9/bili.php?id=bMTV"},
    {name: "👖🔞裤佬丨Hanime丨爬虫",
      address: "https://learnpython.ggff.net/Hanime"},
    {name: "👖🔞裤佬丨ThePorn丨爬虫",
      address: "https://learnpython.ggff.net/ThePorn"},
    {name: "👖🔞裤佬丨四虎丨爬虫",
      address: "http://zhangqun1818.serv00.net:5052/?sp=四虎视频"},
    {name: "👖🔞裤佬丨传媒丨爬虫",
      address: "https://learnpython.ggff.net/XHSM"},
    {name: "👖🔞裤佬丨情趣丨爬虫",
      address: "https://learnpython.ggff.net/7QU"}
]},
  cms: {list: [
{name: "👖🔞裤佬丨麻花丨采集",
...
{name: "👖🔞裤佬丨香蕉丨采集",
address: "https://www.xiangjiaozyw.com/api.php/provide/vod/?ac=list"},
{name: "👖🔞裤佬丨幸资源丨采集",
